  ...
  return (
    <div className="container mx-auto relative">
      ...
      <Link to="/" className="fixed top-10 left-6">
        <img src={skullImg} alt="skull" className="w-16 h-16 object-contain " />
      </Link>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto container ">
        <div className="grid lg:grid-cols-2 gap-6">
          {Blogs.map((member) => (
            <Link
              to={`/blog/${member._id}`}
              className="group relative block rounded-2xl dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 picbox"
              href="#"
            >
